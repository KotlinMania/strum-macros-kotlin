...
kotlin {
    ...
    val xcf = XCFramework("StrumMacros")

    macosArm64 {
        binaries.framework { baseName = "StrumMacros"; xcf.add(this) }
    }
    iosArm64 {
        binaries.framework { baseName = "StrumMacros"; xcf.add(this) }
    }
    ...
    swiftExport {
        moduleName = "StrumMacros"
        flattenPackage = "io.github.kotlinmania.strummacros"
    }

    android {
        namespace = "io.github.kotlinmania.strummacros"
        compileSdk = 34
        minSdk = 24
...
mavenPublishing {
    ...
    coordinates(group.toString(), "strum-macros-kotlin", version.toString())

    pom {
        name.set("strum-macros-kotlin")
        description.set("Kotlin Multiplatform port of Peternator7/strum - Helpful macros for working with enums and strings")
        inceptionYear.set("2026")
        url.set("https://github.com/KotlinMania/strum-macros-kotlin")
        ...
        scm {
            url.set("https://github.com/KotlinMania/strum-macros-kotlin")
            connection.set("scm:git:git://github.com/KotlinMania/strum-macros-kotlin.git")
            developerConnection.set("scm:git:ssh://github.com/KotlinMania/strum-macros-kotlin.git")
        }
    }
}
...
val fullTargetBuildTasks = listOf(
    ...
    "assembleStrumMacrosXCFramework",
    "assembleStrumMacrosDebugXCFramework",
    "assembleStrumMacrosReleaseXCFramework",
    "assembleDebugIosFatFrameworkForStrumMacrosXCFramework",
    "assembleReleaseIosFatFrameworkForStrumMacrosXCFramework",
    "assembleDebugIosSimulatorFatFrameworkForStrumMacrosXCFramework",
    "assembleReleaseIosSimulatorFatFrameworkForStrumMacrosXCFramework",
    "assembleDebugMacosFatFrameworkForStrumMacrosXCFramework",
    "assembleReleaseMacosFatFrameworkForStrumMacrosXCFramework",
    "assembleDebugTvosFatFrameworkForStrumMacrosXCFramework",
    "assembleReleaseTvosFatFrameworkForStrumMacrosXCFramework",
    "assembleDebugTvosSimulatorFatFrameworkForStrumMacrosXCFramework",
    "assembleReleaseTvosSimulatorFatFrameworkForStrumMacrosXCFramework",
    "assembleDebugWatchosFatFrameworkForStrumMacrosXCFramework",
    "assembleReleaseWatchosFatFrameworkForStrumMacrosXCFramework",
    "assembleDebugWatchosSimulatorFatFrameworkForStrumMacrosXCFramework",
    "assembleReleaseWatchosSimulatorFatFrameworkForStrumMacrosXCFramework",
