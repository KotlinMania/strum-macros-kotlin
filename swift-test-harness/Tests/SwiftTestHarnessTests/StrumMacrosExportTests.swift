...
// of the pipeline:
//
//   1. `embedSwiftExportForXcode` produced `StrumMacros.swiftmodule/`
...
//      `import StrumMacros` above would fail at compile time.
//
//   2. The static archive `libStrumMacros.a` (produced by the
...
//      architecture arm64".
//
//   3. The Kotlin `swiftExport { moduleName = "StrumMacros" }` and
//      `flattenPackage = "io.github.kotlinmania.strummacros"` configuration in
...
//      via the `StrumMacrosLibrary` product.
//
...
final class StrumMacrosExportTests: XCTestCase {
    func testSwiftModuleLoads() throws {
        XCTAssertTrue(true, "StrumMacros swift module imported cleanly")
    }
}
