...
- **Function parity:** 44/44 matched (target 78) — 100.0%
- **Class/type parity:** 19/20 matched (target 47) — 95.0%
- **Combined symbol parity:** 63/64 matched (target 125) — 98.4%
...
### 10. helpers.inner_variant_props
...
| Source | Target | Path |
|--------|--------|------|
| `strum_macros.lib` | `strummacros.Lib` | `strum_macros/src/lib` |
