...
This file is the quick-reference operating contract for strum-macros-kotlin. The longer
...
strum-macros-kotlin is a Kotlin Multiplatform port of the upstream Rust crate or module
[`strum_macros`](https://crates.io/crates/strum_macros). Upstream Rust is the behavioral oracle while the
